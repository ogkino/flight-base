...
return [
    ...
    // View mode / custom-action iframe dialogs (_foot.php injects as window.VIEW_I18N; JS uses vt(key))
    'view' => [
        // Common
        'cancel'             => 'Cancel',
        'confirm'            => 'OK',
        ...
        'please_select'      => 'Please select',
        'unnamed'            => 'Unnamed',
        'refresh_hint'       => 'Please refresh the list to see the latest status',
